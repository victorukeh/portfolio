    ...
    <section className="carousel">
      ...
      <div className="carousel-item">
          ...
          <div className="carousel-item__details">
            ...
            <h5 className="carousel-item__details--title">Spotify Clone</h5>
            <h6 className="carousel-item__details--subtitle">It was made due to my desire to create a music application while <wbr></wbr>consuming high level endpoints like the spotify web api.</h6>
          </div>
        </div>
        <a href="http://ukehmeets.onrender.com/" target="_blank" rel="noreferrer"><div className="carousel-item">
          <img
            className="carousel-item__img"
          ...
          <div className="carousel-item__details">
            ...
            <h6 className="carousel-item__details--subtitle">I built a web meeting application with the MERN stack to efficiently <wbr></wbr>conduct meetings and keep track of progress.</h6>
          </div>
        </div></a> 
        <div className="carousel-item">
          <img
          ...
          <div className="carousel-item__details">
            ...
            <h5 className="carousel-item__details--title">Portfolio Website</h5>
